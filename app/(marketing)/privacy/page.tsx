  ...
  return (
    <article className="max-w-[720px] mx-auto px-6 lg:px-10 py-20 lg:py-28">
      ...
      <div className="prose-legal">
        <h2>1. Who we are</h2>
        <p>
          Venti Scale is operated by Dustin Gilmour (&quot;Venti Scale&quot;, &quot;we&quot;, &quot;us&quot;, &quot;I&quot;). Contact:{" "}
          <a href="mailto:hello@ventiscale.com">hello@ventiscale.com</a>.
        </p>

        <h2>2. What we collect</h2>
        <p>When you submit a contact form on this website, we collect:</p>
        <ul>
          <li>Your name</li>
        ...
        <ul>
          <li>To reply to your contact form submissions</li>
        ...
        <p>
          We do not sell your information. We do not share it with third parties except
          where necessary to run the service (see Section 4).
        </p>
        ...
        <p>
          ...
          after cancellation. Contact form submissions are kept for 12 months. After
          those periods, data is permanently deleted from our active systems.
        </p>
